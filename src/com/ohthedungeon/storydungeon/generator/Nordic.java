...
import com.ohthedungeon.storydungeon.generator.noise.Voronoi.DistanceMetric;
...
public class Nordic extends BaseGenerator {
     ...
     */
    private static void setMaterialAt(final AsyncChunk chunk_data, final int x, final int y, final int z, final Material material) {
        chunk_data.setBlock(x, y, z, material);
    }

    private static Material getMaterialAt(final AsyncChunk chunk_data, final int x, final int y, final int z) {
...
//        }
     ...
     */
    private void genWater(final BiomeGrid biomes, final int x, final int z, final AsyncChunk chunk_data) {
        int y = 48;
        while (y > 29) {
